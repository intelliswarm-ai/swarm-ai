...
public class WebSearchTool implements BaseTool {
    ...
    private Map<String, Object> searchWeb(String query, String ticker) {
        ...
        try {
            ...
            // If no search APIs are configured, return concise "no data" response
            if (searchResults.isEmpty()) {
                Map<String, Object> info = new HashMap<>();
                info.put("title", "No web search results available");
                info.put("description", "No search API keys configured. Use SECFilingsTool for SEC data.");
    ...
    private Map<String, Object> searchFinancialNews(String query, String ticker) {
        ...
        try {
            ...
            if (articles.isEmpty()) {
                Map<String, Object> info = new HashMap<>();
                info.put("title", "No financial news available");
                info.put("description", "No news API keys configured.");
                articles.add(info);
            }
    ...
    private Map<String, Object> searchMarketData(String ticker) {
        ...
        try {
            ...
            if (!marketData.containsKey("price")) {
                marketData.put("note", "No market data available — API key not configured or call failed");
            }
    ...
    private Map<String, Object> searchCompanyOverview(String ticker) {
        ...
        try {
            ...
            if (!overview.containsKey("name")) {
                overview.put("note", "No company overview available — API key not configured or call failed");
            }
    ...
    private Map<String, Object> searchSocialMedia(String query, String ticker) {
        ...
        try {
            ...
            sentiment.put("note", "No social media APIs configured. Sentiment data not available.");
    ...
    private String formatSearchResults(Map<String, Object> searchResults,
        ...
        if (!hasConfiguredAPIs()) {
            report.append("**Note:** No external search APIs configured. Results limited to SEC data.\n");
        }
